...
VIEW(STRUCT([allElements, COLOR([0.898,0.8784,0.8353]) (roundAboutTrasl), COLOR([0.753,0.8588,0.6078])(T([1,2])([9,9])(round2)), COLOR([1,0.937,0.835])(moreBuildings), COLOR([0.651,0.7764,1])(reflectionLake),COLOR([0.753,0.8588,0.6078]) (bigLawn)]))
