...
ramp = STRUCT(NN(4)([step3D,T([1,3])([2.66,2.5/2])]))
ramp1 = T([1,2,3])([-12.6,-9,-7])(ramp)
ramp2 = R([1,2])(PI/2)(ramp1)


plus = STRUCT([building, ramp2])
VIEW(plus)
